package com.zhowin.nineimage.view;
...
import com.zhowin.nineimage.R;
import com.zhowin.nineimage.adapter.NineGridImageViewAdapter;
import com.zhowin.nineimage.call.ItemImageClickListener;
import com.zhowin.nineimage.call.ItemImageLongClickListener;
...
public class NineGroupImageView<T> extends ViewGroup {
    ...
    public NineGroupImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NineGroupImageView);
        this.mGap = (int) typedArray.getDimension(R.styleable.NineGroupImageView_imgGap, 0);
        this.mSingleImgSize = typedArray.getDimensionPixelSize(R.styleable.NineGroupImageView_singleImgSize, -1);
        this.mShowStyle = typedArray.getInt(R.styleable.NineGroupImageView_showStyle, STYLE_GRID);
        this.mMaxSize = typedArray.getInt(R.styleable.NineGroupImageView_maxSize, 9);
        typedArray.recycle();
    }
    ...
    private ImageView getImageView(final int position) {
        if (position < mImageViewList.size()) {
            ...
            if (mAdapter != null) {
                ImageView imageView = mAdapter.createImageView(getContext());
